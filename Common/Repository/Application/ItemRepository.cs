...
namespace Common.Repository.Application
{
    public class ItemRepository : IItemRepository
    {
        ...
        {
            var get = myContext.Items.Include("Supplier").Where(x => x.Id.ToString().Contains(param) || x.Name.Contains(param) || x.Price.ToString().Contains(param) || x.Stock.ToString().Contains(param) || x.Supplier.Name.ToString().Contains(param)).ToList();
            return get;
        }
